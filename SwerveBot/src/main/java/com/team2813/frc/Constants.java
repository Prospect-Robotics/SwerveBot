...
public final class Constants {
    ...
    // Steer offsets
    public static double FRONT_LEFT_STEER_OFFSET = 0;
    public static double FRONT_RIGHT_STEER_OFFSET = 0;
    public static double BACK_LEFT_STEER_OFFSET = 0;
    public static double BACK_RIGHT_STEER_OFFSET = 0;
