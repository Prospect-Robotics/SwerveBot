...
import com.team2813.lib.swerve.controllers.Falcon500DriveController;
import com.team2813.lib.swerve.controllers.NeoDriveController;
...
public class Mk4SwerveModuleHelper {
    ...
    public static SwerveModule createFalcon500(
        ...
        container.addNumber("Current Velocity", driveController::getStateVelocity);
